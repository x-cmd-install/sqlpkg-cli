...
[![x-cmd/install — sqlpkg-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/sqlpkg-cli.svg?lang=zh)](https://x-cmd.com/install/sqlpkg-cli)
...
合计: **5,375** 行代码（覆盖前 5 种语言、共 **77** 个文件）。
...
- **上游仓库**: <https://github.com/nalgeon/sqlpkg-cli>
- **官网**: <https://sqlpkg.org>
- **许可证**: MIT
...
- **Star**: 260 · **Fork**: 6 · **开放 issue**: 21 · **贡献者**: 1

## 累计统计

- **发布数**: 7 · **已合并 PR**: 0 · **开放 PR**: 0 · **已关闭 issue**: 21 · **开放 issue**: 0 · **提交数**: 87
...
sqlpkg-cli 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `sqlpkg-cli` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/sqlpkg-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:59:47Z._
